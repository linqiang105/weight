object PrepareMaintainForm: TPrepareMaintainForm
  ...
  object PageControl1: TPageControl
    ...
    object TSFaHuo: TTabSheet
      Caption = #21457#36135#21333#20301
      ImageIndex = 1
      OnShow = TabSheetShow
    end
    object TSShouHuo: TTabSheet
    ...
    object TSBackup1: TTabSheet
      Caption = #22791#29992'1'
      ImageIndex = 6
      OnShow = TabSheetShow
    end
    object TSBackup2: TTabSheet
      Caption = #22791#29992'2'
      ImageIndex = 7
      OnShow = TabSheetShow
    end
    object TSBackup3: TTabSheet
      Caption = #22791#29992'3'
      ImageIndex = 8
      OnShow = TabSheetShow
    end
    object TSBackup4: TTabSheet
      Caption = #22791#29992'4'
      ImageIndex = 9
      OnShow = TabSheetShow
    end
    object TSBackup5: TTabSheet
